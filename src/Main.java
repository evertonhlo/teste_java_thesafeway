...
public class Main {
	...
	public static void main(String[] args) {
		...
		// como boa prática entrei com as chaves antes do atributo
		...
		Produto produto = new Produto(1, "Pão Francês", 5, 3.50, empresa2);
		Produto produto2 = new Produto(2, "Coturno", 10, 400.0, empresa);
		Produto produto3 = new Produto(3, "Jaqueta Jeans", 15, 150.0, empresa);
		Produto produto4 = new Produto(4, "Calça Sarja", 15, 150.0, empresa);
		...
		Produto produto9 = new Produto(9, "Croissant", 7, 6.50, empresa2);
		Produto produto10 = new Produto(10, "Chá Gelado", 4, 5.50, empresa2);
		...
		Usuario usuario2 = new Usuario("empresa", "1234", null, empresa2);
		Usuario usuario3 = new Usuario("cliente", "1234", cliente, null);
		Usuario usuario4 = new Usuario("cliente2", "1234", cliente2, null);
		Usuario usuario5 = new Usuario("empresa1", "1234", null, empresa);
